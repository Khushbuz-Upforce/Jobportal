...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 via-gray-300 to-white px-4">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg border border-yellow-400">
        <div className="Logo pb-3 flex align-center items-center justify-center">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 bg-yellow hover:bg-yellow-500 text-black font-semibold rounded-md transition duration-200"
          >
